...
var Walker = (function (_super) {
    ...
    Walker.prototype.visitCallExpression = function (node) {
        ...
        if (tsutils.isPropertyAccessExpression(expression)) {
            ...
            if ((name_1 === "throw") && util_1.couldBeType(type, "Observable")) {
                if (!argument || !util_1.couldBeType(typeChecker.getTypeAtLocation(argument), "Error")) {
            ...
            if (signature) {
                ...
                if (((name_2 === "_throw") || (name_2 === "throwError")) && util_1.couldBeType(returnType, "Observable")) {
                    if (!argument || !util_1.couldBeType(typeChecker.getTypeAtLocation(argument), "Error")) {
                        this.addFailureAtNode(argument, Rule.FAILURE_STRING);
                    }
                }
    ...
    Walker.prototype.visitThrowStatement = function (node) {
        ...
        if (!util_1.couldBeType(type, "Error")) {
